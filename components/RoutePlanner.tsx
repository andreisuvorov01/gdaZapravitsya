...
export default function RoutePlanner({
  ...
  return (
    <div className="route-planner glass-dock">
      <div className="route-planner__head">
        <span className="route-planner__icon" aria-hidden>
          <RouteIcon className="h-4 w-4" />
        </span>
        <div className="min-w-0 flex-1">
          <p className="text-sm font-bold text-white">Заправки по пути</p>
        ...
        <button
          ...
          className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg text-ink-muted hover:bg-white/10"
        >
