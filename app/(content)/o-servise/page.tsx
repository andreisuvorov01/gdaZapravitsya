...
export const metadata: Metadata = {
  ...
  description:
    "«Бенз-Атлас» — бесплатная краудсорсинговая карта наличия топлива на АЗС России. Как работает сервис, откуда данные и кто их добавляет.",
  alternates: { canonical: absoluteUrl("/o-servise") },
  openGraph: {
    title: "О сервисе Бенз-Атлас",
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <h1 className="font-display text-3xl font-extrabold tracking-tight text-ink sm:text-4xl">
        О сервисе «Бенз-Атлас»
      </h1>

      <div className="mt-6 space-y-4 text-base leading-relaxed text-ink-muted">
        <p>
          «Бенз-Атлас» — это бесплатная народная карта наличия топлива на
