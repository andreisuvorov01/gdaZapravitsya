...
export const metadata: Metadata = {
  ...
  description:
    "Как работает карта наличия топлива «Бенз-Атлас», откуда берутся данные, официальные ли они, бесплатно ли это и как считаются статусы АЗС.",
  alternates: { canonical: absoluteUrl("/faq") },
  openGraph: {
    title: "Вопросы и ответы — Бенз-Атлас",
    description:
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
      ...
      <p className="mt-4 text-base leading-relaxed text-ink-muted">
        Коротко о том, как устроена народная карта наличия топлива «Бенз-Атлас» и
        как ей пользоваться.
      </p>
