...
export const gdeNaytiDizel: ArticleBlock[] = [
  lead("Дизель (ДТ, «солярка») при дефиците заканчивается не одновременно с бензином. На ", mapLink("карте Бенз-Атлас"), " можно отфильтровать заправки именно с дизелем."),
...
export const gazomotornoeToplivo: ArticleBlock[] = [
  lead("Владельцам ГБО важно знать, ", mapLink("где заправиться газом"), ". На карте «Бенз-Атлас» есть фильтр «Газ» (СУГ/КПГ)."),
