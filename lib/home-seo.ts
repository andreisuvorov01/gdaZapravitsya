...
export const HOME_PAGE_TITLE =
  "Где бензин сейчас? бензрядом — карта АЗС России";
...
export const HOME_PAGE_DESCRIPTION =
  "Где бензин сейчас? бензрядом — карта АЗС России: наличие топлива, очереди и лимиты по отметкам водителей. Бесплатно, без регистрации.";
