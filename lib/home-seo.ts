...
export const HOME_PAGE_TITLE =
  "Где бензин сейчас? ГдеЗаправиться.рф — карта АЗС России";
...
export const HOME_PAGE_DESCRIPTION =
  "Где бензин сейчас? ГдеЗаправиться.рф — карта АЗС России: наличие топлива, очереди и лимиты по отметкам водителей. Бесплатно, без регистрации.";
